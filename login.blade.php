    ...
    <section
        ...
        <div
            ...
            <a
                ...
                href="/"
                title="Return Home">
                <i class="fas fa-chevron-left"></i> Return Home/Retourner <!-- French update 1.0 (not really) -->
            </a>

            <div
                class="login-heading">

                <h1>Login to Talent Cloud    Connexion au Talent Cloud       <!--French Fry's French here -->         
                </h1>
                            ...
                            <div
                                    ...
                                    <div
                                        ...
                                        <label
                                            ...
                                            <input
                                                ...
                                                name="remember"
                                                type="checkbox"> Remember Me/Souviens-toi de moi <!-- Formatting here needs work. There we are --> 
                                        </label>
                                ...
                                <div
                                    ...
                                    <a
                                        ...
                                        Register/S'inscrire <!-- parle francais mon ami? Hi more french here -->
                                    </a>
                                </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <a
                                ...
                                <small>Forgot Password/Mot De Passe Oublié</small> <!-- French here, get your french--> 
                            </a>
                        ...
                        <div
                            ...
                            <button
                                ...
                                type="submit">
                                Login/S'identifier <!-- French Bonjour Croissant -->
